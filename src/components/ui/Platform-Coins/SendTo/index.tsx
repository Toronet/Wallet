...
import { calculatePlatCoinFee, verifyPlatCoinTransaction } from '../../../../redux/coins/coins-slice';
    ...
    const onFinish = async (values: any): Promise<any> => {
        ...
        if (!payload.result) {
            ...
            Modal.confirm({
                ...
                content: `This transaction will have a fee of ${payload.fee} ${selectedCoin.name}. Do you want to continue ?`,
                okText: 'Go Ahead',
                okType: 'primary',
                cancelText: 'No',
                onOk() {
