...
import { calculateCoinFee, calculateBuyCoinResult, verifyCoinTransaction } from '../../../../redux/coins/coins-slice';
...
const ExchangeFrom: React.FC<TProps> = ({ coins, callback, selectedCoin, onSelect }): JSX.Element => {
    ...
    }, [selectedCoin, form, rates, balance]);
